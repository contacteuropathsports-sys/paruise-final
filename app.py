...
<style>
    ...
    [data-testid="stSidebar"] {
        background-color: #4A0E19 !important; /* Bordeaux Profond */
...
if menu == "🛒 Nouvelle Vente (Caisse)":
    ...
    with c1:
        ...
        client_nom = st.selectbox("Rechercher la cliente", cli_list, label_visibility="collapsed")
...
Tu vas être rayonnante avec ça ! Envoie-nous une photo quand tu le portes. ✨"""
            ...
            st.warning("⚠️ Sélectionne une cliente.")
    st.markdown("</div>", unsafe_allow_html=True)
